...
import ParallaxSlide from "@components/slide/parallax";
import DotIndicator from "@components/indicator/dot";
import { useArrowDarkButtonStyles } from "@styles/components/button/arrowDark";
...
const ParallaxCarousel = () => {
  ...
  const renderElements = ({ index, onChangeIndex }: any) => (
    <>
      <Button
